...
.. only:: html
  ...
  .. image:: /examples/liver/images/thumb/sphx_glr_plot_tristan_mdosing_thumb.png
    :alt:

  :ref:`sphx_glr_examples_liver_plot_tristan_mdosing.py`
...
.. only:: html
  ...
  .. image:: /examples/liver/images/thumb/sphx_glr_plot_tristan_volunteers_thumb.png
    :alt:

  :ref:`sphx_glr_examples_liver_plot_tristan_volunteers.py`
...
.. raw:: html
    ...
    <div class="sphx-glr-thumbcontainer" tooltip="The data show in this example aimed to demonstrates the effect of rifampicin  on liver function of patients with impaired function. The use  case is provided by the liver work package of the  TRISTAN project  which develops imaging  biomarkers for drug safety assessment. ">

.. only:: html

  .. image:: /examples/liver/images/thumb/sphx_glr_plot_tristan_patients_thumb.png
    :alt:

  :ref:`sphx_glr_examples_liver_plot_tristan_patients.py`

.. raw:: html

      <div class="sphx-glr-thumbnail-title">Clinical - rifampicin effect in subjects with impaired liver function</div>
    </div>
...
.. only:: html
  ...
  .. image:: /examples/liver/images/thumb/sphx_glr_plot_tristan_volunteers_2scan_thumb.png
    :alt:

  :ref:`sphx_glr_examples_liver_plot_tristan_volunteers_2scan.py`
...
.. only:: html
  ...
  .. image:: /examples/liver/images/thumb/sphx_glr_plot_tristan_repro_thumb.png
    :alt:

  :ref:`sphx_glr_examples_liver_plot_tristan_repro.py`
...
.. only:: html
  ...
  .. image:: /examples/liver/images/thumb/sphx_glr_plot_tristan6drugs_thumb.png
    :alt:

  :ref:`sphx_glr_examples_liver_plot_tristan6drugs.py`
...
.. only:: html
  ...
  .. image:: /examples/tutorials/images/thumb/sphx_glr_plot_aif_thumb.png
    :alt:

  :ref:`sphx_glr_examples_tutorials_plot_aif.py`
...
.. only:: html
  ...
  .. image:: /examples/tutorials/images/thumb/sphx_glr_plot_wex_thumb.png
    :alt:

  :ref:`sphx_glr_examples_tutorials_plot_wex.py`
...
.. only:: html
  ...
  .. image:: /examples/tutorials/images/thumb/sphx_glr_plot_minipig_thumb.png
    :alt:

  :ref:`sphx_glr_examples_tutorials_plot_minipig.py`
...
.. only:: html
  ...
  .. image:: /examples/tutorials/images/thumb/sphx_glr_plot_convolution_thumb.png
    :alt:

  :ref:`sphx_glr_examples_tutorials_plot_convolution.py`
...
.. toctree::
   ...
   /examples/kidney/index.rst
   /examples/liver/index.rst
