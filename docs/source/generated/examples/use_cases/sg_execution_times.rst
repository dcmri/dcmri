...
Computation times
=================
**00:06.407** total execution time for 5 files **from generated\examples\use_cases**:
...
.. container::
   ...
   * - Example
     - Time
     - Mem (MB)
   * - :ref:`sphx_glr_generated_examples_use_cases_plot_tristan_mdosing.py` (``plot_tristan_mdosing.py``)
     - 00:06.407
     - 0.0
