...
def synth_1(
    ...
    """Synthetic data generated using Parker's AIF, an extended Tofts tissue and a steady-state sequence.
    ...
    Args:
        ...
        Ktrans (float, optional): Volume transfer constant in 1/sec. Defaults to 0.2/60.
        ...
        R1b (_type_, optional): Precontrast relaxation rate for blood in 1/sec. Defaults to 1/dc.T1(3.0, 'blood').
    ...
    """
    t = np.arange(0, tacq+dt, 0.1)
    cp = dc.aif_parker(t, BAT)
    C = dc.conc_etofts(cp, vp, Ktrans, ve, dt=dt)
    ...
    gt = {'t':t, 'cp':cp, 'C':C, 'vp':vp, 'Ktrans':Ktrans, 've':ve}
