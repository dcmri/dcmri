...
# +---------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
# |                                                             AortaLiverDynamicDrugModel - all inputs (n = 130)                                                             |
# +----------------+------------+--------------------------------------------------------------------------+-----------------+------------+---------------+-------+-----------+
...
# +------------------------------------------------------------------------------------------------------------------------------+
# |                                      AortaLiverDynamicDrugModel - all outputs (n = 82)                                       |
# +----------+----------+------------------------------------------------+-----------------+-------+---------+-------+-----------+
# | Key      | Unit     | Name                                           | Group           | Init  | Bounds  | DICOM | OSIPI     |
# +----------+----------+------------------------------------------------+-----------------+-------+---------+-------+-----------+
...
class AortaLiverDynamicDrugModel(Module):
    ...
    def __init__(self, imap:dict=None, omap:dict=None, **config):
        ...
        vars = AortaLiverDynamicModel.all_outputs()
        ...
        for visit in visits:
            ...
            self._aol[visit] = AortaLiverDynamicModel(imap=imap_visit, omap=omap_visit, **self.config)
