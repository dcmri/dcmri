...
SEQUENCES = {
    ...
    'ZTE-3D-IR-SPGR-SS': {
        ...
        'parameters': {
            'tissue': {'R1'},
            'read': {'FA', 'B1corr'},
            'prep': {'TR', 'FA', 'B1corr', 'Nph', 'Nk0', 'TP', 'TD'},
        },
    },
    '3D-SPGR-SS': {
        'mz_prep_tissue': 'SPGR-SS',
    ...
    '3D-PR-SPGR-SS': {
        ...
        'parameters': {
            'tissue': {'R1', 'R2s'},
            'read': {'FA', 'B1corr', 'TE'},
            'prep': {'TR', 'FA', 'B1corr', 'Nph', 'Nk0', 'TP', 'PA', 'TD'},
        },
    },
    '2D-SPGR-SS': {
        'mz_prep_tissue': 'SPGR-SS',
    ...
    '3D-PR-SPGR': {
        ...
        'parameters': {
            'tissue': {'R1', 'R2s'},
            'read': {'FA', 'B1corr', 'TE'},
            'prep': {'TR', 'FA', 'B1corr', 'Nph', 'Nk0', 'PA', 'TP', 'TD'},
        },
    },
    '3D-PR-SS': {
    ...
    '2D-SR-SPGR': {
        ...
        'parameters': {
            'tissue': {'R1', 'R2s'},
            'read': {'FA', 'B1corr', 'TE'},
            'prep': {'TR', 'FA', 'B1corr', 'Nph', 'Nk0', 'TP', 'TD', 'iz'},
        },
    },
    '3D-SPGR-SSI': {
        'mz_prep_tissue': 'SSI',
        ...
        'parameters': {
            'tissue': {'R1', 'R2s'},
            'read': {'FA', 'B1corr', 'TE'},
            'prep': {'TR', 'FA', 'B1corr', 'Nph', 'Nk0', 'TF', 'SA'},
        },
    },
    '2D-GE-EPI': {
