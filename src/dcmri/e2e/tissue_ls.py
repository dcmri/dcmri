...
class TissueLS(SuperPixelModel):
    ...
    def _train(self, time, signal, n0=1, tol=0.1):
        ...
        def _conc_pixel(x):
            ...
            C_x = SignalToConc(seq, defaults=kwargs_x)(signal[x, ...], n0=n0)
            ...
            s_ref = Signal(seq, defaults=kwargs_x)(R1=kwargs_x['R1b'], R2=0, R2s=0, S0=1, **CONSTANTS)
            s_ref = np.mean(s_ref)
