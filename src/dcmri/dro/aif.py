...
def tristan(
    ...
    .. plot::
        ...
        plt.plot(t/60, 1000*dc.aif.tristan(t, BAT=30), 'r-', label='AIF (default)')
        plt.plot(t/60, 1000*dc.aif.tristan(t, BAT=30, CO=150), 'g-', 
                 label='AIF (increased cardiac output)')
        plt.plot(t/60, 1000*dc.aif.tristan(t, BAT=30, CO=75), 'b-', 
    ...
    Ji = pk.ca_injection(t, weight,conc, dose, rate, BAT)
    Jb = pk.flux_aorta(Ji, t, E=E,
