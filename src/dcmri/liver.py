...
def _conc_2i_ic(ci, t=None, dt=1.0, sum=True, **p):
    ...
    Ktrans = p['Fp'] * p['E']
    return _conc_liver(
        ca, ve_app, cv=cv, Ta=p['Ta'], fa=p['fa'], Ktrans=Ktrans, 
...
def _conc_2i_ic_u(ci, t=None, dt=1.0, sum=True, **p):
    ...
    Ktrans = p['Fp'] * p['E']
    return _conc_liver(
        ca, ve_app, cv=cv, Ta=p['Ta'], fa=p['fa'], Ktrans=Ktrans, Te=Te,
        t=t, dt=dt, sum=sum,
    )
